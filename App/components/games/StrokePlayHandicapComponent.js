...
export default class StrokePlayHandicapComponent extends React.Component {
...
renderRows() {
    ...
    Object.keys(rankings).forEach(function(key) {
      ...
      <View style={styles.textContainer}>
      <View style={styles.hdcTextContainer}>
        <Text style={styles.gameDataText}> { rankings[key]['chcp'] } </Text>
      </View>
    </View>
        <View style={styles.textContainer}>
    ...
    return (
      <View style={styles.container}>
        <View style={styles.gameDataContainer}>
            ...
            <Text style={styles.columnText}> Hcp </Text>
            <Text style={styles.columnText}> Net </Text>
