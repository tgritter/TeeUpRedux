...
renderRows() {
    ...
    Object.keys(rankings).forEach(function(key) {
      ...
      var userurl = 'https://firebasestorage.googleapis.com/v0/b/teeupbetadev.appspot.com/o/1200px-Golfer_swing.jpg?alt=media&token=cdb9b158-671a-42e7-a8cf-2f7f6696e9b6';
    ...
    return (
      <View style={styles.container}>
        <View style={styles.gameDataContainer}>
            ...
            <Text style={styles.columnText}> HolesWon </Text>
