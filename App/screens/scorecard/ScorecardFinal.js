...
class ScorecardFinal extends React.Component {
  ...
  constructor(props){
    ...
    this.itemsRef = this.getRef().child('scorecards/scorecardStrokes/' + this.props.scorecardViewID);
  }
  ...
  getItems(itemsRef){
    ...
    itemsRef.on('value',(snap) => {
        ...
        console.log('ScorecardIDTEst:' + this.props.scorecardViewID)
  ...
  submitScorecard(){
    ...
    var scorecardGlobalData = {
      ...
      userimage: scorecard.user_info.image, userid: scorecard.user_info.userid, scorecardID: scorecard.user_info.scorecardID
      }
...
const mapStateToProps = (state) => ({
  scorecardViewID: state.viewScorecard.scorecardViewID,
});

export default connect(mapStateToProps)(ScorecardFinal);
