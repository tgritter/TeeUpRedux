...
import { gameID, courseIDData } from '../../actions'
...
class GameList extends React.Component {
  ...
  pressRow(item){
    ...
    this.props.gameID(item.gameID);
    this.props.courseIDData(item.courseid);
...
export default connect(mapStateToProps, { gameID, courseIDData })(GameList);
